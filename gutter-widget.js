/**
 * Atlanta Gutter Guard Pros - Chat Widget (Local Version)
 * Customized Service Bot for Gutter Services
 */

(function() {
  // Configuration for Gutter Services
  const defaultConfig = {
    serverUrl: 'http://localhost:3010', // Updated to port 3010
...
<div style="margin-top: 15px; display: flex; flex-direction: column; gap: 10px;">
  <button onclick="startConversation('I need gutter guards installed')" style="background: #2c3e50; color: white; padding: 10px 20px; border: none; border-radius: 6px; cursor: pointer; font-weight: 600;">
    🛡️ Get Gutter Guards Quote
  </button>
  <button onclick="startConversation('I need gutter cleaning')" style="background: #3498db; color: white; padding: 10px 20px; border: none; border-radius: 6px; cursor: pointer; font-weight: 600;">
...
<p style="margin-top: 15px; font-size: 14px; color: #666;">We serve all of Metro Atlanta with free estimates and lifetime warranties!</p>`,
  ...
  window.startConversation = function(message) {
    document.getElementById('gutter-bot-input').value = message;
    sendMessage();
  };
